        ...
        <>
          ...
          <div className="fixed top-[60px] left-0 right-0 bg-white z-50 md:hidden border-b shadow-lg max-h-[calc(100vh-120px)] overflow-y-auto">
            ...
            <div className="py-2">
              ...
              {(isAdmin || isSeller) && <div className="border-t my-2" />}

              {isAdmin && (
                <Link
                  href="/admin"
                  className="flex items-center gap-3 px-6 py-3 bg-blue-50 text-blue-700 hover:bg-blue-100 active:bg-blue-200 transition"
                  onClick={() => setShowMobileMenu(false)}
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {isSeller && (
                <Link
                  href="/seller"
                  className="flex items-center gap-3 px-6 py-3 bg-green-50 text-green-700 hover:bg-green-100 active:bg-green-200 transition"
                  onClick={() => setShowMobileMenu(false)}
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
