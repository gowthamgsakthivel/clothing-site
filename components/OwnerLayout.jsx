...
const OwnerLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-900 text-sm md:text-base">
      ...
      <div className={`flex min-h-screen flex-col transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${isCollapsed ? 'lg:pl-20' : 'lg:pl-[270px]'}`}>
        {/* Top Header Navbar */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative hidden md:block group">
                ...
                <input
                  ...
                  className="w-56 lg:w-64 rounded-xl border border-slate-200 bg-slate-50/50 py-2.5 pl-10 pr-12 text-sm text-slate-800 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all shadow-sm"
                />
        ...
        {/* Main View Area */}
        <main className="flex-1 px-4 py-6 sm:px-6 lg:px-8 w-full max-w-full">
          <div className="w-full text-slate-900 text-sm md:text-base">
            {children}
          </div>
        </main>
      </div>
