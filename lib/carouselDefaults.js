...
export const DEFAULT_CAROUSEL_CONTROLS = {
  home: [
    {
      id: 1,
      badge: '⚡ 2026 PRO ATHLETIC SERIES',
      title: 'Engineered for Champions — Pro Dri-FIT T-Shirts',
      subtitle: 'Ultra-breathable 4-way stretch fabric crafted for peak endurance and tournament performance.',
      offer: 'FLAT 30% OFF • LIMITED TIME',
      buttonText1: 'Shop Pro T-Shirts',
      buttonText2: 'Custom Jersey',
      link1: '/all-products?category=T-Shirts',
      link2: '/custom-design',
      highlights: ['Dri-FIT Moisture Control', 'Featherlight 160 GSM', 'Anti-Chafe Comfort'],
    ...
    {
      id: 2,
      badge: '🔥 HIGH-PERFORMANCE TRAINING',
      title: 'Power Every Movement — Active Stretch Sports Shorts',
      subtitle: 'Flexible, lightweight design with zippered phone pockets for running, gym & field games.',
      offer: 'BUY 2 GET 15% OFF',
      buttonText1: 'Shop Sports Shorts',
      buttonText2: 'Explore Gear',
      link1: '/all-products?category=Shorts',
      link2: '/sports',
      highlights: ['Quick-Dry Breathable', 'Secure Zip Pockets', 'Athletic Fit'],
    ...
    {
      id: 3,
      badge: '🏆 PODIUM EDITION',
      title: 'All-Weather Warmup — Premium Track & Training Jackets',
      subtitle: 'Wind-resistant thermal sportswear designed for morning training, warmups & team travel.',
      offer: 'EXCLUSIVE NEW LAUNCH',
      buttonText1: 'Shop Jackets',
      buttonText2: 'Team Uniforms',
      link1: '/all-products',
      link2: '/custom-design',
      highlights: ['Thermal Regulation', 'Wind & Rain Shield', 'Tapered Sport Fit'],
