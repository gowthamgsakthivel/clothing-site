...
export default function ContactPage() {
    ...
    return (
        <>
            <Navbar />
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-pink-50 to-yellow-50 flex flex-col items-center justify-center py-16 px-4 pt-16 md:pt-20">
